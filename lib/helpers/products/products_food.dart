      ...
      body: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              children: <Widget>[
                Text('Healthy', style: TextStyle(fontFamily: 'Montserrat', color: Colors.white, fontWeight: FontWeight.bold, fontSize: 25.0)),
                SizedBox(width: 10.0),
                Text('Food', style: TextStyle(fontFamily: 'Montserrat', color: Colors.white, fontSize: 25.0))
              ],
            ),
          ),
                ...
                Padding(
                    ...
                    child: Container(
                        ...
                        child: ListView(children: [
                          _buildFoodItem('assets/helpers/food/plate1.png', 'Salmon bowl', '\$24.00'),
                          _buildFoodItem('assets/helpers/food/plate2.png', 'Spring bowl', '\$22.00'),
                          _buildFoodItem('assets/helpers/food/plate6.png', 'Avocado bowl', '\$26.00'),
                          _buildFoodItem('assets/helpers/food/plate5.png', 'Berry bowl', '\$24.00')
                        ]))),
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Center(child: Text('Checkout', style: TextStyle(fontFamily: 'Montserrat', color: Colors.white, fontSize: 15.0))),
                    )
                  ],
                )
              ],
